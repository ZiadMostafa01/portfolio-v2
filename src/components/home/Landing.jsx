          ...
          <div className="flex flex-wrap gap-8 mb-12">
            ...
            >
              ...
              <a
                ...
                className="flex items-center gap-2 bg-linear-to-r from-[#c084fc] to-[#6366f1] text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-primary/20 hover:-translate-y-1 transition-all"
              >
